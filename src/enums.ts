...
export const FusionMessageIdValues : {[key: string]: number} = {
  ...
  [FusionMessageId.Source]: 0x2,
  [FusionMessageId.TrackInfo]: 0x4,
  [FusionMessageId.TrackTitle]: 0x5,
  [FusionMessageId.TrackArtist]: 0x6,
  [FusionMessageId.TrackAlbum]: 0x7,
  [FusionMessageId.TrackProgress]: 0x9,
  [FusionMessageId.AmfmStation]: 0xb,
  [FusionMessageId.Vhf]: 0xc,
  [FusionMessageId.Squelch]: 0xd,
  [FusionMessageId.Scan]: 0xe,
  [FusionMessageId.Mute]: 0x11,
  [FusionMessageId.Replay]: 0x14,
  [FusionMessageId.SetZoneVolume]: 0x18,
  [FusionMessageId.SetAllVolumes]: 0x19,
  [FusionMessageId.SubVolume]: 0x1a,
  [FusionMessageId.Tone]: 0x1b,
  [FusionMessageId.Volume]: 0x1d,
  [FusionMessageId.Power]: 0x20,
  [FusionMessageId.UnitName]: 0x21,
  [FusionMessageId.SiriusXmChannel]: 0x24,
  [FusionMessageId.SiriusXmTitle]: 0x25,
  [FusionMessageId.SiriusXmArtist]: 0x26,
  [FusionMessageId.SiriusXmGenre]: 0x28,
  [FusionMessageId.ZoneName]: 0x2d,
}
