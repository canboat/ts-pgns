...
export enum ManufacturerCode {
  ...
  HumminbirdMarineElectronics2 = 'Humminbird Marine Electronics 2',
...
export const ManufacturerCodeValues: {[key: string]: number} = {
  ...
  [ManufacturerCode.HondaMarine2]: 0xc8,
  ...
  [ManufacturerCode.HondaMarine3]: 0xe1,
  ...
  [ManufacturerCode.HondaMarine4]: 0xfa,
  ...
  [ManufacturerCode.BepMarine2]: 0x127,
  ...
  [ManufacturerCode.HumminbirdMarineElectronics2]: 0x1dc,
  ...
  [ManufacturerCode.Garmin2]: 0x285,
 ...
 * @category Enumerations
 */
export const Seatalk1AttValues: {[key: string]: number} = {
  [Seatalk1Att.DepthBelowTransducer]: 0x0,
}
